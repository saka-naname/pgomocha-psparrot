...
const mat7 = (yPos, deg) => {
    return yPos - Math.abs(yPos) * ((0 + sinDeg(deg)) / 18);
}

const mat8 = (yPos, deg) => {
    return yPos - 400 * ((0 + sinDeg(deg)) / 18);
}
